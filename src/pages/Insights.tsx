...
function Insights(): JSX.Element {
  ...
  useEffect(() => {
    ...
    fetchCallDetails();
    const intervalId = setInterval(fetchCallDetails, 5000);
        ...
        {loading ? (
          ...
          >
            ...
            <div className="text-center flex flex-col gap-y-6">
              ...
              <p className="text-neutral-200 text-center text-lg sm:text-xl md:text-2xl font-body px-4">
                Your conversation is currently in progress. The analysis will appear here once the call is completed.
              </p>
            </div>
          </motion.div>
        ) : (
          <>
            ...
            >
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-neutral-900/50 backdrop-blur-xl border border-white/[0.08] shadow-xl">
                ...
                <p className="text-neutral-300 leading-relaxed text-lg">
                  {insights?.user_sentiment || "No sentiment data available"}
                </p>
              </div>
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-neutral-900/50 backdrop-blur-xl border border-white/[0.08] shadow-xl">
                ...
                <div className="space-y-3">
                  {insights?.transcript ? (
                    parseTranscript(insights.transcript).map((message, index) => (
                      <motion.div
                        key={index}
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className={`text-xs sm:text-sm pr-4 sm:pr-8 font-medium font-heading ${message.role === 'User' ? 'text-purple-400' : 'text-teal-400'}`}>
                              {message.role}
                            </span>
                          </div>
